...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	T.Identifier happy_dollar_dollar -> cont 7;
	T.Lambda -> cont 8;
	T.Dot -> cont 9;
	T.OpenParen -> cont 10;
	T.CloseParen -> cont 11;
	_ -> happyError' ((tk:tks), [])
	}
...
happyThen :: () => P.Parser a -> (a -> P.Parser b) -> P.Parser b
happyThen = (Prelude.>>=)
happyReturn :: () => a -> P.Parser a
happyReturn = (Prelude.return)
happyThen1 m k tks = (Prelude.>>=) m (\a -> k a tks)
happyReturn1 :: () => a -> b -> P.Parser a
happyReturn1 = \a tks -> (Prelude.return) a
happyError' :: () => ([(T.Token)], [Prelude.String]) -> P.Parser a
